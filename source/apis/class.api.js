...
export class ClassApi
{
  ...
  //获取机构的基础信息
  cutchat(json, callback, showLoading = true) {
    ...
    console.log(header);
    wx.request({
      url: ApiConfig.GetApiUrl() + 'class/cutchat',
      data: json,
      method: 'POST',
      dataType: 'json',
      header: header,
  ...
  //获取机构的基础信息
  teacherlist(json, callback, showLoading = true) {
    ...
    console.log(header);
    wx.request({
      url: ApiConfig.GetApiUrl() + 'class/teacherlist',
      data: json,
      method: 'POST',
      dataType: 'json',
      header: header,
  ...
  //获取机构的基础信息
  allclass(json, callback, showLoading = true) {
    ...
    console.log(header);
    wx.request({
      url: ApiConfig.GetApiUrl() + 'class/allclass',
      data: json,
      method: 'POST',
      dataType: 'json',
      header: header,
